...
import { ILoggerConfig, ILogInput } from './interface';
import { DEFAULT_CONFIG, DEFAULT_REDACT_CONFIG, DEFAULT_TRANSPORT_CONFIG } from './const';
import { getUserId, serializedError } from './utils';
...
export class Logger {
  ...
  private getCommonData(data?: ILogInput) {
    return data
      ? {
  ...
  private formatResBodyString(body: string) {
